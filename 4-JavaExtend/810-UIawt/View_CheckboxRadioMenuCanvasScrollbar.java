...
public class View_CheckboxRadioMenuCanvasScrollbar extends Frame implements ActionListener, ItemListener, AdjustmentListener {
   ...
   public View_CheckboxRadioMenuCanvasScrollbar() {
   ...
   public static void main(String[] args) {
      View_CheckboxRadioMenuCanvasScrollbar c1 = new View_CheckboxRadioMenuCanvasScrollbar();      	   
   }
